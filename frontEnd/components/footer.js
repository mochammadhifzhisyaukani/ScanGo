      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6">
          ...
          <ul class="list-unstyled text-muted">
            ...
            <li class="mb-2"><a href="/frontend/page/structure/assets.html" class="text-secondary text-decoration-none">Aktiva</a></li>
        ...
        <div class="col-lg-2 col-6">
          ...
          <ul class="list-unstyled text-muted">
            ...
            <li class="mb-2"><a href="/frontend/page/structure/ourEcosystem.html" class="text-secondary text-decoration-none">Ekosistem Kita</a></li>
          </ul>
        </div>
      </div>
