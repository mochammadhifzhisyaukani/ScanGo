...
const kontenKelas = {
    ...
    XI: `
        <div class="p-4 bg-white rounded-4 shadow-sm text-center">
            <h4 class="text-muted"><i class="bi bi-mortarboard fs-1 d-block mb-3 text-info"></i>Konten Monitoring Kelas XI</h4>
            <p class="mb-0">Silakan isi data stat-card dan tabel absensi khusus Kelas XI di sini.</p>
        </div>
    `,
    XII: `
        <div class="p-4 bg-white rounded-4 shadow-sm text-center">
            <h4 class="text-muted"><i class="bi bi-mortarboard fs-1 d-block mb-3 text-success"></i>Konten Monitoring Kelas XII</h4>
            <p class="mb-0">Silakan isi data stat-card dan tabel absensi khusus Kelas XII di sini.</p>
        </div>
    `
};
