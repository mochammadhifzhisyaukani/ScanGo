...
content.innerHTML = ` <div class="card">
            ...
            <div class="left-panel">
                <div class="logo">
                    <!-- Logo: two lightning/slash marks -->
                    <img src="/src/assets/logo/favicon.png" alt="" width="60px">
                </div>

                <h1>Masuk</h1>
                <p class="subtitle">Lanjutkan untuk mengakses dasbor anda</p>
                ...
                <div class="field-group">
                    <div class="field-header">
                        ...
                        <span class="forgot-link">Lupa kata sandi?</span>
                    </div>
                ...
                <p class="create-account">Saya tidak punya akun? <a href="signUp.html">Buat Akun</a></p>
            </div>
