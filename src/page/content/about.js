...
content.innerHTML = `
    <section class="hero-section animate__animated animate__fadeInDown">
        <div class="text-center">
            <h1 class="title animate__animated animate__zoomInDown text-white" style="margin-top: 8%; font-size: 70px;">Membangun Sistem Absensi <br> Digital yang Efisien</h1>
            <p class="animate__animated animate__fadeInUp text-white">Mengubah pelacakan tradisional menjadi pengalaman digital yang mulus bagi institusi modern.</p>
    ...
    <div class="container px-4 about" style="margin-top: 10%;">
        <div class="row gx-5 row-stretch">
            <div class="col-lg-6">
                <div class="p-3">
                    ...
                    <button class="badge reveal mt-3">TENTANG KITA</button>
        ...
        <div class="container-sm" style="margin-top: 8%;">
            ...
            <div class="text-center mb-5">
                <button class="badge reveal badge-dev">PENGEMBANG</button>
                <h1 class="mt-2 title reveal title-dev" style="color: var(--color-teks);">Lihat Siapa yang Membuatnya</h1>
